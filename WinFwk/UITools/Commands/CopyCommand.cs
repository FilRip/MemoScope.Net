...
namespace WinFwk.UITools.Commands
{
    ...
    {
        public CopyCommand() : base("Copy", "Copy to clipboard", UIToolBarSettings.Main.Name, Properties.Resources.page_copy, Keys.Control | Keys.Shift | Keys.C, UIToolBarSettings.SubGroupData)
        {
